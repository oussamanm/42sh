...
/*   Updated: 2019/11/22 10:50:16 by aboukhri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/read_line.h"

/*  get history command by taking the shortcut starting from head or tail acording to index */ 
...
/* get history command by keyword given in the direction given (1 -> next | 0 -> prev) */
...
void    insert_history(t_history *history, char *cmd)
{
    ...
    {
        history->tail->next = new_history(history->tail->index + 1, cmd, history->tail);
