...
OBJS = error_handler.o\
	...
	utility/helper_subshell.o utility/helper_expans.o\
	utility/helper_redir.o\
	...
	builtins_cmds/alias_finder.o builtins_cmds/alias_srcs.o\
	builtins_cmds/alias_list.o\
